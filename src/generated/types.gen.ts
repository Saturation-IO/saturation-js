...
export type CreateBudgetLinesResponse =
  CreateBudgetLinesResponses[keyof CreateBudgetLinesResponses];
...
export type UploadActualAttachmentError =
  UploadActualAttachmentErrors[keyof UploadActualAttachmentErrors];
...
export type UploadActualAttachmentResponse =
  UploadActualAttachmentResponses[keyof UploadActualAttachmentResponses];
...
export type ListPurchaseOrdersData = {
  ...
  query?: {
    ...
    status?:
      ...
      | 'pending'
      | 'paid'
      | Array<'draft' | 'approved' | 'rejected' | 'pending' | 'paid'>;
    /**
     * Include related data in the response
     */
...
export type UploadPurchaseOrderAttachmentError =
  UploadPurchaseOrderAttachmentErrors[keyof UploadPurchaseOrderAttachmentErrors];
...
export type UploadPurchaseOrderAttachmentResponse =
  UploadPurchaseOrderAttachmentResponses[keyof UploadPurchaseOrderAttachmentResponses];
...
export type CreateBudgetPhaseResponse =
  CreateBudgetPhaseResponses[keyof CreateBudgetPhaseResponses];
...
export type DeleteBudgetPhaseResponse =
  DeleteBudgetPhaseResponses[keyof DeleteBudgetPhaseResponses];
...
export type UpdateBudgetPhaseResponse =
  UpdateBudgetPhaseResponses[keyof UpdateBudgetPhaseResponses];
...
export type ListBudgetFringesResponse =
  ListBudgetFringesResponses[keyof ListBudgetFringesResponses];
...
export type CreateBudgetFringeResponse =
  CreateBudgetFringeResponses[keyof CreateBudgetFringeResponses];
...
export type DeleteBudgetFringeResponse =
  DeleteBudgetFringeResponses[keyof DeleteBudgetFringeResponses];
...
export type UpdateBudgetFringeResponse =
  UpdateBudgetFringeResponses[keyof UpdateBudgetFringeResponses];
...
export type ListBudgetGlobalsResponse =
  ListBudgetGlobalsResponses[keyof ListBudgetGlobalsResponses];
...
export type CreateBudgetGlobalResponse =
  CreateBudgetGlobalResponses[keyof CreateBudgetGlobalResponses];
...
export type DeleteBudgetGlobalResponse =
  DeleteBudgetGlobalResponses[keyof DeleteBudgetGlobalResponses];
...
export type UpdateBudgetGlobalResponse =
  UpdateBudgetGlobalResponses[keyof UpdateBudgetGlobalResponses];
...
export type UploadContactTaxDocumentError =
  UploadContactTaxDocumentErrors[keyof UploadContactTaxDocumentErrors];
...
export type UploadContactTaxDocumentResponse =
  UploadContactTaxDocumentResponses[keyof UploadContactTaxDocumentResponses];
...
export type UploadContactAttachmentError =
  UploadContactAttachmentErrors[keyof UploadContactAttachmentErrors];
...
export type UploadContactAttachmentResponse =
  UploadContactAttachmentResponses[keyof UploadContactAttachmentResponses];
...
export type UploadTransactionAttachmentError =
  UploadTransactionAttachmentErrors[keyof UploadTransactionAttachmentErrors];
...
export type UploadTransactionAttachmentResponse =
  UploadTransactionAttachmentResponses[keyof UploadTransactionAttachmentResponses];
...
export type ListWorkspaceRatesResponse =
  ListWorkspaceRatesResponses[keyof ListWorkspaceRatesResponses];
...
export type CreateWorkspaceRateResponse =
  CreateWorkspaceRateResponses[keyof CreateWorkspaceRateResponses];
...
export type DeleteWorkspaceRateResponse =
  DeleteWorkspaceRateResponses[keyof DeleteWorkspaceRateResponses];
...
export type UpdateWorkspaceRateResponse =
  UpdateWorkspaceRateResponses[keyof UpdateWorkspaceRateResponses];
...
export type GetPublicRatepackRatesError =
  GetPublicRatepackRatesErrors[keyof GetPublicRatepackRatesErrors];
...
export type GetPublicRatepackRatesResponse =
  GetPublicRatepackRatesResponses[keyof GetPublicRatepackRatesResponses];
