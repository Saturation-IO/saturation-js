...
import type {
  ...
  GetProjectBudgetResponses,
  GetProjectBudgetErrors,
  CreateBudgetLinesData,
  CreateBudgetLinesResponses,
  CreateBudgetLinesErrors,
  DeleteBudgetLineData,
  DeleteBudgetLineResponses,
  DeleteBudgetLineErrors,
  GetBudgetLineData,
  GetBudgetLineResponses,
  GetBudgetLineErrors,
  UpdateBudgetLineData,
  UpdateBudgetLineResponses,
  UpdateBudgetLineErrors,
  ListActualsData,
  ListActualsResponses,
  ListActualsErrors,
  DeleteActualData,
  DeleteActualResponses,
  DeleteActualErrors,
  GetActualData,
  GetActualResponses,
  GetActualErrors,
  CreateActualData,
  CreateActualResponses,
  CreateActualErrors,
  UpdateActualData,
  UpdateActualResponses,
  UpdateActualErrors,
  UploadActualAttachmentData,
  UploadActualAttachmentResponses,
  UploadActualAttachmentErrors,
  ...
  UploadPurchaseOrderAttachmentData,
  UploadPurchaseOrderAttachmentResponses,
  UploadPurchaseOrderAttachmentErrors,
  ListBudgetPhasesData,
  ListBudgetPhasesResponses,
  ListBudgetPhasesErrors,
  CreateBudgetPhaseData,
  CreateBudgetPhaseResponses,
  CreateBudgetPhaseErrors,
  DeleteBudgetPhaseData,
  DeleteBudgetPhaseResponses,
  DeleteBudgetPhaseErrors,
  GetBudgetPhaseData,
  GetBudgetPhaseResponses,
  GetBudgetPhaseErrors,
  UpdateBudgetPhaseData,
  UpdateBudgetPhaseResponses,
  UpdateBudgetPhaseErrors,
  ListBudgetFringesData,
  ListBudgetFringesResponses,
  ListBudgetFringesErrors,
  CreateBudgetFringeData,
  CreateBudgetFringeResponses,
  CreateBudgetFringeErrors,
  DeleteBudgetFringeData,
  DeleteBudgetFringeResponses,
  DeleteBudgetFringeErrors,
  GetBudgetFringeData,
  GetBudgetFringeResponses,
  GetBudgetFringeErrors,
  UpdateBudgetFringeData,
  UpdateBudgetFringeResponses,
  UpdateBudgetFringeErrors,
  ListBudgetGlobalsData,
  ListBudgetGlobalsResponses,
  ListBudgetGlobalsErrors,
  CreateBudgetGlobalData,
  CreateBudgetGlobalResponses,
  CreateBudgetGlobalErrors,
  DeleteBudgetGlobalData,
  DeleteBudgetGlobalResponses,
  DeleteBudgetGlobalErrors,
  GetBudgetGlobalData,
  GetBudgetGlobalResponses,
  GetBudgetGlobalErrors,
  UpdateBudgetGlobalData,
  UpdateBudgetGlobalResponses,
  UpdateBudgetGlobalErrors,
  ListCommentsData,
  ...
  UpdateContactErrors,
  UploadContactTaxDocumentData,
  UploadContactTaxDocumentResponses,
  UploadContactTaxDocumentErrors,
  UploadContactAttachmentData,
  UploadContactAttachmentResponses,
  UploadContactAttachmentErrors,
  ...
  UploadTransactionAttachmentData,
  UploadTransactionAttachmentResponses,
  UploadTransactionAttachmentErrors,
  ListWorkspaceRatesData,
  ListWorkspaceRatesResponses,
  ListWorkspaceRatesErrors,
  CreateWorkspaceRateData,
  CreateWorkspaceRateResponses,
  CreateWorkspaceRateErrors,
  DeleteWorkspaceRateData,
  DeleteWorkspaceRateResponses,
  DeleteWorkspaceRateErrors,
  UpdateWorkspaceRateData,
  UpdateWorkspaceRateResponses,
  UpdateWorkspaceRateErrors,
  ListPublicRatesData,
  ListPublicRatesResponses,
  ListPublicRatesErrors,
  GetPublicRatepackRatesData,
  GetPublicRatepackRatesResponses,
  GetPublicRatepackRatesErrors,
} from './types.gen';
 ...
 */
export const getProjectBudget = <ThrowOnError extends boolean = false>(
  options: Options<GetProjectBudgetData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetProjectBudgetResponses,
    GetProjectBudgetErrors,
 ...
 *
 */
export const createBudgetLines = <ThrowOnError extends boolean = false>(
  options: Options<CreateBudgetLinesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateBudgetLinesResponses,
    CreateBudgetLinesErrors,
 ...
 *
 */
export const deleteBudgetLine = <ThrowOnError extends boolean = false>(
  options: Options<DeleteBudgetLineData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteBudgetLineResponses,
    DeleteBudgetLineErrors,
 ...
 *
 */
export const getBudgetLine = <ThrowOnError extends boolean = false>(
  options: Options<GetBudgetLineData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetBudgetLineResponses,
    GetBudgetLineErrors,
 ...
 *
 */
export const updateBudgetLine = <ThrowOnError extends boolean = false>(
  options: Options<UpdateBudgetLineData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateBudgetLineResponses,
    UpdateBudgetLineErrors,
 ...
 */
export const listActuals = <ThrowOnError extends boolean = false>(
  options: Options<ListActualsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    ListActualsResponses,
    ListActualsErrors,
 ...
 */
export const deleteActual = <ThrowOnError extends boolean = false>(
  options: Options<DeleteActualData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteActualResponses,
    DeleteActualErrors,
 ...
 */
export const getActual = <ThrowOnError extends boolean = false>(
  options: Options<GetActualData, ThrowOnError>,
) => {
 ...
 */
export const createActual = <ThrowOnError extends boolean = false>(
  options: Options<CreateActualData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateActualResponses,
    CreateActualErrors,
 ...
 */
export const updateActual = <ThrowOnError extends boolean = false>(
  options: Options<UpdateActualData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateActualResponses,
    UpdateActualErrors,
 ...
 */
export const uploadActualAttachment = <ThrowOnError extends boolean = false>(
  options: Options<UploadActualAttachmentData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UploadActualAttachmentResponses,
    UploadActualAttachmentErrors,
 ...
 */
export const listPurchaseOrders = <ThrowOnError extends boolean = false>(
  options: Options<ListPurchaseOrdersData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    ListPurchaseOrdersResponses,
    ListPurchaseOrdersErrors,
 ...
 * Accepts PDF or image files up to 10&nbsp;MB.
 */
export const uploadPurchaseOrderAttachment = <ThrowOnError extends boolean = false>(
  options: Options<UploadPurchaseOrderAttachmentData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UploadPurchaseOrderAttachmentResponses,
    UploadPurchaseOrderAttachmentErrors,
 ...
 */
export const listBudgetPhases = <ThrowOnError extends boolean = false>(
  options: Options<ListBudgetPhasesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    ListBudgetPhasesResponses,
    ListBudgetPhasesErrors,
 ...
 */
export const createBudgetPhase = <ThrowOnError extends boolean = false>(
  options: Options<CreateBudgetPhaseData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateBudgetPhaseResponses,
    CreateBudgetPhaseErrors,
 ...
 */
export const deleteBudgetPhase = <ThrowOnError extends boolean = false>(
  options: Options<DeleteBudgetPhaseData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteBudgetPhaseResponses,
    DeleteBudgetPhaseErrors,
 ...
 */
export const getBudgetPhase = <ThrowOnError extends boolean = false>(
  options: Options<GetBudgetPhaseData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetBudgetPhaseResponses,
    GetBudgetPhaseErrors,
 ...
 */
export const updateBudgetPhase = <ThrowOnError extends boolean = false>(
  options: Options<UpdateBudgetPhaseData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateBudgetPhaseResponses,
    UpdateBudgetPhaseErrors,
 ...
 */
export const listBudgetFringes = <ThrowOnError extends boolean = false>(
  options: Options<ListBudgetFringesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    ListBudgetFringesResponses,
    ListBudgetFringesErrors,
 ...
 */
export const createBudgetFringe = <ThrowOnError extends boolean = false>(
  options: Options<CreateBudgetFringeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateBudgetFringeResponses,
    CreateBudgetFringeErrors,
 ...
 */
export const deleteBudgetFringe = <ThrowOnError extends boolean = false>(
  options: Options<DeleteBudgetFringeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteBudgetFringeResponses,
    DeleteBudgetFringeErrors,
 ...
 */
export const getBudgetFringe = <ThrowOnError extends boolean = false>(
  options: Options<GetBudgetFringeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetBudgetFringeResponses,
    GetBudgetFringeErrors,
 ...
 */
export const updateBudgetFringe = <ThrowOnError extends boolean = false>(
  options: Options<UpdateBudgetFringeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateBudgetFringeResponses,
    UpdateBudgetFringeErrors,
 ...
 */
export const listBudgetGlobals = <ThrowOnError extends boolean = false>(
  options: Options<ListBudgetGlobalsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    ListBudgetGlobalsResponses,
    ListBudgetGlobalsErrors,
 ...
 */
export const createBudgetGlobal = <ThrowOnError extends boolean = false>(
  options: Options<CreateBudgetGlobalData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateBudgetGlobalResponses,
    CreateBudgetGlobalErrors,
 ...
 */
export const deleteBudgetGlobal = <ThrowOnError extends boolean = false>(
  options: Options<DeleteBudgetGlobalData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteBudgetGlobalResponses,
    DeleteBudgetGlobalErrors,
 ...
 */
export const getBudgetGlobal = <ThrowOnError extends boolean = false>(
  options: Options<GetBudgetGlobalData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetBudgetGlobalResponses,
    GetBudgetGlobalErrors,
 ...
 */
export const updateBudgetGlobal = <ThrowOnError extends boolean = false>(
  options: Options<UpdateBudgetGlobalData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateBudgetGlobalResponses,
    UpdateBudgetGlobalErrors,
 ...
 * Accepts PDF or image files up to 10&nbsp;MB.
 */
export const uploadContactTaxDocument = <ThrowOnError extends boolean = false>(
  options: Options<UploadContactTaxDocumentData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UploadContactTaxDocumentResponses,
    UploadContactTaxDocumentErrors,
 ...
 * Accepts PDF or image files up to 10&nbsp;MB.
 */
export const uploadContactAttachment = <ThrowOnError extends boolean = false>(
  options: Options<UploadContactAttachmentData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UploadContactAttachmentResponses,
    UploadContactAttachmentErrors,
 ...
 */
export const uploadTransactionAttachment = <ThrowOnError extends boolean = false>(
  options: Options<UploadTransactionAttachmentData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UploadTransactionAttachmentResponses,
    UploadTransactionAttachmentErrors,
 ...
 */
export const listWorkspaceRates = <ThrowOnError extends boolean = false>(
  options?: Options<ListWorkspaceRatesData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    ListWorkspaceRatesResponses,
    ListWorkspaceRatesErrors,
 ...
 */
export const createWorkspaceRate = <ThrowOnError extends boolean = false>(
  options: Options<CreateWorkspaceRateData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateWorkspaceRateResponses,
    CreateWorkspaceRateErrors,
 ...
 */
export const deleteWorkspaceRate = <ThrowOnError extends boolean = false>(
  options: Options<DeleteWorkspaceRateData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteWorkspaceRateResponses,
    DeleteWorkspaceRateErrors,
 ...
 */
export const updateWorkspaceRate = <ThrowOnError extends boolean = false>(
  options: Options<UpdateWorkspaceRateData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).put<
    UpdateWorkspaceRateResponses,
    UpdateWorkspaceRateErrors,
 ...
 */
export const listPublicRates = <ThrowOnError extends boolean = false>(
  options?: Options<ListPublicRatesData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    ListPublicRatesResponses,
    ListPublicRatesErrors,
 ...
 */
export const getPublicRatepackRates = <ThrowOnError extends boolean = false>(
  options: Options<GetPublicRatepackRatesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetPublicRatepackRatesResponses,
    GetPublicRatepackRatesErrors,
