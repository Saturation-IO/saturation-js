 ...
 */
export const getProjectBudget = <ThrowOnError extends boolean = false>(options: Options<GetProjectBudgetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectBudgetResponses, GetProjectBudgetErrors, ThrowOnError>({
        querySerializer: {
            array: {
                explode: false,
                style: 'form'
 ...
 */
export const listPublicRates = <ThrowOnError extends boolean = false>(options?: Options<ListPublicRatesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListPublicRatesResponses, ListPublicRatesErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 */
export const getPublicRatepackRates = <ThrowOnError extends boolean = false>(options: Options<GetPublicRatepackRatesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPublicRatepackRatesResponses, GetPublicRatepackRatesErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
